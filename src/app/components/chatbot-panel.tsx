...
const mockInspections: NetworkInspection[] = [
  {
    ...
    details:
      "Collects user behavior data and page interactions for analytics purposes",
    dataShared: [
      "User ID",
      "Page views",
      "Session duration",
  ...
  },
  {
    ...
    details:
      "Third-party advertising network with extensive cross-site tracking capabilities",
    dataShared: [
      "Browsing history",
      "Location data",
      "Device fingerprint",
  ...
  },
  {
    ...
    details:
      "Standard content delivery network for static assets and libraries",
  ...
  },
  {
    ...
    details:
      "Social media pixel for conversion tracking and audience building",
    dataShared: [
      "Profile data",
      "Page visits",
      "Custom events",
  ...
  },
  {
    ...
    details:
      "Encrypted payment gateway with PCI compliance for secure transactions",
  ...
  },
  {
    ...
    details:
      "Advanced fingerprinting service that creates unique device signatures",
    dataShared: [
      "Canvas fingerprint",
      "WebGL data",
      "Font list",
  ...
  },
  {
    ...
    details:
      "Public weather data API with minimal data collection",
  ...
  },
  {
    ...
    details:
      "Cookie syncing for cross-domain retargeting campaigns",
    dataShared: [
      "Cookie IDs",
      "Site visits",
      "Product views",
...
export function AnalysisPage() {
  ...
  const stats = {
    ...
    safe: mockInspections.filter((i) => i.status === "safe")
      .length,
    warning: mockInspections.filter(
      (i) => i.status === "warning",
    ).length,
    suspicious: mockInspections.filter(
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-slate-600">
                Detailed analysis of privacy and security
              </p>
            </div>
            <Button
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <Badge
                        className={`ml-4 ${getRiskColor(inspection.riskLevel)}`}
                      >
